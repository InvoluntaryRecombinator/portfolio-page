    ...
    caseStudy: {
      ...
      execution: [
        ...
        },
        {
          ...
          description:
            "Government PDF forms are decoded from their opaque AcroForm field names into a deterministic map, and structured user data is written into that map to populate every form and its cover sheet. Each filled document is then read back from its own generated bytes and checked against what was written, so a silent bad write can't reach the packet.",
        },
      ],
    },
  },
